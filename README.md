...
![The proposed patch loss](https://github.com/Patch-Loss-for-Super-Resolution/utils/img/example.png)


Sincere thanks to the developers of the [BasicSR](https://github.com/XPixelGroup/BasicSR) project.
